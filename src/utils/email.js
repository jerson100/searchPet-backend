...
const sendRegisterTokenEmail = async (to, token, name) => {
  const message = createEmail({
    from: process.env.PRIVATE_REGISTER_EMAIL,
    to,
    subject: "Verificación de correo electrónico - SearchPet",
    html: `
        ...
        * {
        ...
        table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 40% !important; } #u_content_heading_1 .v-font-size { font-size: 38px !important; } #u_content_text_5 .v-container-padding-padding { padding: 10px 30px 11px 10px !important; } }
            </style>
        ...
        <tr>
            ...
            <img align="center" border="0" src="https://res.cloudinary.com/dgakkw9kj/image/upload/v1672974995/public/searchpet/image-6_rdngp7.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 24%;max-width: 139.2px;" width="139.2" class="v-src-width v-src-max-width"/>
        ...
        <h1 class="v-font-size" style="margin: 0px; color: #27187e; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 36px;"><strong>Bienvenido a SearchPet</strong></h1>
        ...
        <div style="color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 190%;"><span style="font-size: 18px; line-height: 34.2px;"><strong><span style="line-height: 34.2px; font-size: 18px;">Hola ${name}, te saluda </span><span style="line-height: 34.2px; font-size: 18px; color: #3598db;"><span style="font-size: 18px; line-height: 34.2px;"><a rel="noopener" href="https://www.facebook.com/jersonomar.ramirezortiz/" target="_blank" style="color: #3598db;">Jerson Ramírez</a></span></span><span style="line-height: 34.2px; font-size: 18px;"> desarrollador de la app.</span></strong></span></p>
        <p style="font-size: 14px; line-height: 190%;"><span style="font-size: 16px; line-height: 30.4px;">Muchas gracias por registrarte en la aplicación. Antes de que puedas usar tu cuenta, tenemos que confirmar que realmente eres tú. Por favor, pulse en confirmar cuenta.</span></p>
        </div>
        ...
        <div align="center">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${process.env.FRONTEND_URL}/auth/verify?token=${token}" style="height:49px; v-text-anchor:middle; width:231px;" arcsize="0%"  stroke="f" fillcolor="#3598db"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->  
            <a href="${process.env.FRONTEND_URL}/auth/verify?token=${token}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #3598db; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 0px; border-top-style: solid; border-top-color: #CCC; border-left-width: 0px; border-left-style: solid; border-left-color: #CCC; border-right-width: 0px; border-right-style: solid; border-right-color: #CCC; border-bottom-width: 0px; border-bottom-style: solid; border-bottom-color: #CCC;">
            <span style="display:block;padding:16px 50px;line-height:120%;"><strong><span style="font-size: 14px; line-height: 16.8px;">Confirmar Cuenta</span></strong></span>
            </a>
        ...
        <tr>
            ...
            <img align="center" border="0" src="https://res.cloudinary.com/dgakkw9kj/image/upload/v1672975001/public/searchpet/image-4_ioxqla.png" alt="border" title="border" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600" class="v-src-width v-src-max-width"/>
        ...
        <!--[if (mso)|(IE)]><table width="143" cellpadding="0" cellspacing="0" border="0"><tr><td style="border-collapse:collapse;" align="center"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; mso-table-lspace: 0pt;mso-table-rspace: 0pt; width:143px;"><tr><![endif]-->
            ...
            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                <a href="https://www.facebook.com/jersonomar.ramirezortiz/" title="Facebook" target="_blank">
                <img src="https://res.cloudinary.com/dgakkw9kj/image/upload/v1672974992/public/searchpet/image-1_uo0phj.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                </a>
            </td></tr>
            </tbody></table>
            <!--[if (mso)|(IE)]></td><![endif]-->
            ...
            <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 16px">
            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                <a href="https://linkedin.com/jerson100" title="LinkedIn" target="_blank">
                <img src="https://res.cloudinary.com/dgakkw9kj/image/upload/v1672975000/public/searchpet/image-2_mvet3w.png" alt="LinkedIn" title="LinkedIn" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                </a>
            </td></tr>
            </tbody></table>
            <!--[if (mso)|(IE)]></td><![endif]-->
            ...
            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                <a href="https://github.com/jerson100" title="GitHub" target="_blank">
                <img src="https://res.cloudinary.com/dgakkw9kj/image/upload/v1672974998/public/searchpet/image-5_af7mlz.png" alt="GitHub" title="GitHub" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                </a>
            </td></tr>
            </tbody></table>
            <!--[if (mso)|(IE)]></td><![endif]-->
        ...
        <div style="color: #908f8f; line-height: 190%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 190%;">© 2023 SearchPet. Todos los derechos reservados</p>
        </div>
        ...
        <tr>
            ...
            <img align="center" border="0" src="https://res.cloudinary.com/dgakkw9kj/image/upload/v1672975000/public/searchpet/image-3_s4iice.png" alt="border" title="border" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600" class="v-src-width v-src-max-width"/>
